...
export type EmbeddedContentStore = {
     ...
     */
    findNearestNeighbors(vector: number[], options?: Partial<FindNearestNeighborsOptions>): Promise<WithScore<EmbeddedContent>[]>;
    /**
...
//# sourceMappingURL=EmbeddedContent.d.ts.map