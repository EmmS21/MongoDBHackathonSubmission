...
export declare type InstanceDecorator<T extends React.ElementType = React.ElementType<any>> = (Instance: StoryFn, context?: InstanceContext) => JSX.Element;
export interface GeneratedStoryConfig<T extends React.ElementType, XP extends Record<string, any> = {}> {
    /**
     ...
     */
    combineArgs?: Partial<{
        [key in keyof ExtendedComponentProps<T, XP>]: Array<ExtendedComponentProps<T, XP>[key]>;
    }>;
    /**
     ...
     */
    args?: Partial<{
        [key in keyof ExtendedComponentProps<T, XP>]: ExtendedComponentProps<T, XP>[key];
    }>;
    /**
     ...
     */
     | [
        ...
        Partial<{
            [key in keyof ExtendedComponentProps<T, XP>]: ExtendedComponentProps<T, XP>[key] | Array<ExtendedComponentProps<T, XP>[key]>;
        }>
    ]
    /**
...
export {};
//# sourceMappingURL=GeneratedStoryDecorator.types.d.ts.map