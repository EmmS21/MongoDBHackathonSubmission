 ...
 * Story Parameters
 */
declare type StoryParameters<
/** The component type */
T extends React.ElementType, 
/** Any eXtra Props the story should support */
XP extends Record<string, any> = {}> = Meta<T>['parameters'] & {
    /**
 ...
 */
declare type ArgTypes<
/** The component type */
T extends React.ElementType, 
/** Any eXtra Props the story should support */
XP extends Record<string, any> = {}> = Partial<{
 ...
 */
export declare type StoryMetaType<
/** The component type */
T extends React.ElementType, 
/** Any eXtra Props the story should support */
XP extends Record<string, any> = {}> = Omit<Meta<T>, 'component' | 'argTypes' | 'args'> & {
    title?: string;
    component?: T;
...
T extends React.ElementType, 
/** Any eXtra Props the story should support */
XP extends Record<string, any> = {}> = StoryFn<ComponentProps<T> & XP> & {
...
export declare type PlayFn<
/** The component type */
T extends React.ElementType, 
/** Any eXtra Props the story should support */
XP extends Record<string, any> = {}> = PlayFunction<ReactRenderer, ComponentProps<T> & XP>;
export {};
//# sourceMappingURL=StoryMeta.types.d.ts.map