 ...
 */
export declare function createIconComponent<G extends GlyphObject = GlyphObject>(glyphs: G): {
    ({ glyph, ...rest }: IconProps): React.JSX.Element;
    displayName: string;
    isGlyph: boolean;
    propTypes: any;
};
export {};
//# sourceMappingURL=createIconComponent.d.ts.map