...
declare const Diagram3: {
    ({ className, size, title, ["aria-label"]: ariaLabel, ["aria-labelledby"]: ariaLabelledby, fill, role, ...props }: Diagram3Props): React.JSX.Element;
    displayName: string;
    isGlyph: boolean;
    propTypes: {
...
//# sourceMappingURL=Diagram3.d.ts.map