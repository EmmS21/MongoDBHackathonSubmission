 ...
 */
declare function Tooltip({ initialOpen, open: controlledOpen, setOpen: controlledSetOpen, darkMode: darkThemeProp, baseFontSize: baseFontSizeOverride, triggerEvent, enabled, align, justify, spacing, usePortal, onClose, id, shouldClose, portalClassName, portalContainer, scrollContainer, popoverZIndex, refEl, className, children, trigger, ...rest }: TooltipProps): any;
