...
export declare const DropdownWidthBasis: {
    readonly Trigger: "trigger";
    readonly Option: "option";
};
export type DropdownWidthBasis = (typeof DropdownWidthBasis)[keyof typeof DropdownWidthBasis];
export interface BaseSelectProps extends Omit<HTMLElementProps<'button', HTMLButtonElement>, 'onChange' | 'onClick'>, Omit<PopoverProps, 'active' | 'spacing'> {
    /**
     ...
     * @internal
     */
    __INTERNAL__menuButtonSlotProps__?: Partial<ButtonProps> & Record<string, any>;
}
...
export type SelectProps = BaseSelectProps & Either<LabelProp, 'label' | 'aria-labelledby' | 'aria-label'> & (// Uncontrolled
({
    /**
