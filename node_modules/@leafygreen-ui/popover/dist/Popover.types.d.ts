...
type TransitionLifecycleCallbacks = Pick<TransitionProps, 'onEnter' | 'onEntering' | 'onEntered' | 'onExit' | 'onExiting' | 'onExited'>;
/**
...
declare const Align: {
    ...
    readonly CenterVertical: "center-vertical";
    readonly CenterHorizontal: "center-horizontal";
};
...
export type PopoverProps = {
     ...
     */
    children: React.ReactNode | ((Options: ChildrenFunctionParameters) => React.ReactNode);
    /**
...
} & PortalControlProps & TransitionLifecycleCallbacks;
/** Props used by the popover component */
export type PopoverComponentProps = Omit<HTMLElementProps<'div'>, 'children'> & PopoverProps;
