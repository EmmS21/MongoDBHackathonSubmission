 ...
 */
import { ChatCompletions, ChatRequestAssistantMessage, ChatRequestMessage, FunctionCallPreset, FunctionDefinition, FunctionName } from "@azure/openai";
...
export interface ChatLlm {
    ...
    answerQuestionAwaited(params: LlmAnswerQuestionParams): Promise<OpenAiAwaitedResponse>;
    callTool?(params: LlmCallToolParams): Promise<CallToolResponse>;
}
//# sourceMappingURL=ChatLlm.d.ts.map