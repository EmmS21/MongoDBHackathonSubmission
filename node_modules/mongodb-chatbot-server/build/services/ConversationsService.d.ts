 ...
 */
export type SomeMessage = UserMessage | AssistantMessage | SystemMessage | FunctionMessage;
/**
...
export type AddFunctionMessageParams = Omit<FunctionMessage, "id" | "createdAt"> & {
    customData?: Record<string, unknown>;
};
export type AddAssistantMessageParams = Omit<AssistantMessage, "id" | "createdAt">;
export type AddSomeMessageParams = AddSystemMessageParams | AddUserMessageParams | AddAssistantMessageParams | AddFunctionMessageParams;
...
export interface ConversationsService {
     ...
     */
    rateMessage: ({ conversationId, messageId, rating, }: RateMessageParams) => Promise<boolean>;
    /**
      Add a user comment to an assistant {@link Message}.
     */
    commentMessage: ({ conversationId, messageId, comment, }: CommentMessageParams) => Promise<boolean>;
}
export declare const defaultConversationConstants: ConversationConstants;
//# sourceMappingURL=ConversationsService.d.ts.map